...
import com.graduation.seniorabilityassessment.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    @Override
    public Boolean updateByAvatar(String avatarUrl,Integer id) {
        return userMapper.updateByAvatar(avatarUrl,id);
    }
